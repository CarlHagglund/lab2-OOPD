...
public class CarView extends JFrame{
    ...
    JButton destroyButton = new JButton("Destroy car");
    ...
    private void initComponents(String title) {
        ...
        controlPanel.add(createButton, 6);
        controlPanel.add(destroyButton, 7);
        ...
        createButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {carC.createCar();}
        });
        destroyButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {carC.destroyCar();}
        });
